...
$plus_img = imagecreatefrompng($assets_path . "/images/flat96/signs/plus-small.png");
...
function drawCircle($image, $x, $y, $diameter, $border_color, $fill_color, $thickness) {
    ...
    imagearc($image, (int)$x, (int)$y, $diameter, $diameter, 0, 360, $border_color);
    imagefilledellipse($image, (int)$x, (int)$y, (int)($diameter - $thickness), (int)($diameter - $thickness), $fill_color);
}
...
imagettftext($back, $font_size, 0, $right_center_x - 60, $right_center_y + 70, $black, $font_file, (string)$t[0]);
drawCircle($back, $right_center_x, $right_center_y - 16 - $circle_radius - $circle_offset, $circle_diameter, $border_color, $white, 2);
imagettftext($back, $font_size, 0, $right_center_x - 10, $right_center_y - 40, $black, $font_file, (string)($t[0] + $t[1]));
drawCircle($back, $right_center_x + 49, $right_center_y + 16 + $circle_radius + $circle_offset, $circle_diameter, $border_color, $white, 2);
imagettftext($back, $font_size, 0, $right_center_x + 38, $right_center_y + 70, $black, $font_file, (string)$t[1]);
