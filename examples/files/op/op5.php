...
// if ($t[2] == 'plus') {echo "plus";}
// if ($t[2] == 'minus') {echo "minus";}

// $sign_img = imagecreatefrompng($assets_path.'/images/flat96/signs/minus.png');
...
draw_rounded_rectangle($back, $second_square_x, (int)($center_y), (int)($second_square_x + $square_size), (int)($center_y + $square_size), (int)($corner_radius), $white, $border_color, $border_thickness);
...
$circle_count = $t[0]; // Кількість кіл дорівнює першому аргументу
...
$circle_count = $t[1]; // Кількість кіл дорівнює другому аргументу
