...
imagecopyresampled($back, $plus_img, (int)$plus_x, (int)$plus_y, 0, 0, (int)$plus_width, (int)$plus_height, imagesx($plus_img), imagesy($plus_img));
...
imagecopyresampled($back, $plus_img, $plus_x, $rect_y + 5, 0, 0, 17, 48, imagesx($plus_img), imagesy($plus_img));
