...
function load_item_image($group_name, $image_name) {
    $item_image_path = "../../images/flat48/{$group_name}/{$image_name}.png"; // Шлях до зображення
    if (file_exists($item_image_path)) {
        ...
        $default_image_path = "../../images/flat48/fruits/orange.png";
...
$delete_img = imagecreatefrompng("../../images/flat48/delete/delete.png"); // Завантажуємо зображення хрестика
