...
// Параметри зображень
$plus_img = imagecreatefrompng("../../images/flat48/signs/plus_big.png");
$eq_img = imagecreatefrompng("../../images/flat48/signs/eq.png");
$word_img = imagecreatefrompng("../../images/flat48/signs/word.png");
...
$plus_y = ($height - $plus_height) / 2; // Центруємо по вертикалі
